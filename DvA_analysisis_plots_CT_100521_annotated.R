...
# path <- path to where want to save figures
...
# #### Supplementary Figure S3: Alpha Values over Time -------------------------------
...
ggsave(paste(path, "Fig_S3.jpg", sep=""), height = 5, width =10)
...
ggsave(paste(path, "Fig_S4.jpg", sep=""), p, height = 5, width =5)
...
all_CT_orf1 <- all_CT %>% drop_na(CT_orf1) # 3 NAs in orf1 target data
...
p 
plot_MA_MGB_orf1 <- p
ggsave(paste(path, "Fig_S5.jpg", sep=""), height = 5, width =5)
...
ggsave(paste(path, "Fig_4.jpg", sep=""), p, height = 7, width =10)
